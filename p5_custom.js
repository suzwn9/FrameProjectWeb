let sketch = function(p) {
    ...
    let myImages = {};
    let strong; 
    let currentStrong;  // 현재 strong 값을 저장하기 위한 변수
    let targetStrong;  // 목표 strong 값을 저장하기 위한 변수
    ...
    p.preload = function() {
        ...
        myImages["2016"] = p.loadImage('img/image2016.jpg');
        myImages["2019"] = p.loadImage('img/image2019.jpg');
        myImages["2022"] = p.loadImage('img/image2022.jpg');
    };

    p.setup = function() {
        let cnv = p.createCanvas(564, 846);
...
let sketch2 = function(p) {
    ...
    function setImage() {
        ...
        imageGap = p.map(strong, 0, 100, 50, 5);
...
function createButtonsForSketch2() {
    let buttonData = [
        { label: '관리직', strength: 81.7 },
        { label: '전문직', strength: 63.6 },
        { label: '사무직', strength: 48.4 },
        { label: '서비스판매직', strength: 48.8 },
        { label: '기능직', strength: 39.6 },
        { label: '기계직', strength: 47.4 },
        { label: '노무직', strength: 33.4 }
    ];
